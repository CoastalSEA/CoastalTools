...
%--------------------------------------------------------------------------
        function menu = setMenus(obj)
            ...
            menu.Setup(offset+2).List = {'Concatenate two timeseries',...
                            ...
                            'Merge cases','Delete multiple profiles',...                
                            'Edit or Delete profile in timeseries'};
            menu.Setup(offset+2).Callback = repmat({@obj.datacleanup},[1,8]);
            menu.Setup(offset+2).Separator = {'off','off','off','off','off','off','on','off'};
